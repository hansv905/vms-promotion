...
export const promotionData: Promotion[] = [
  {
    ...
    image: [
      'https://dummyimage.com/1200x800/f3e5f5/7b1fa2',
      'https://dummyimage.com/1200x800/f3e5f5/7b1fa2',
      'https://dummyimage.com/1200x800/f3e5f5/7b1fa2',
    ],
  },
...
export const promotionDetails: Record<
  string,
  {
...
> = {
  '1': {
    detailedDescription:
      '대한항공 국제선 탑승 시 기본 마일리지에 더해 보너스 마일리지를 2배로 적립해 드립니다. 이코노미석부터 일등석까지 모든 좌석 등급에 적용되며, SKYPASS 회원이라면 누구나 혜택을 받으실 수 있습니다.',
    terms: [
      '대한항공 운항 국제선에만 적용됩니다.',
      '코드쉐어 항공편은 제외됩니다.',
  ...
  '2': {
    detailedDescription:
      '전 세계 제휴 호텔 예약 시 최대 30%까지 할인받으실 수 있으며, 추가로 1박당 500마일리지를 적립해 드립니다. 5성급 호텔부터 비즈니스 호텔까지 다양한 숙박시설을 할인된 가격으로 이용하세요.',
    terms: [
  ...
  '3': {
    detailedDescription:
      '전국 주요 렌터카 업체와 제휴하여 10% 할인 쿠폰을 제공합니다. 국내 여행이나 출장 시 편리하게 차량을 렌트하고 할인 혜택까지 누리세요.',
    terms: [
  ...
  '4': {
    detailedDescription:
      '인천국제공항 면세점에서 SKYPASS 카드 제시 시 추가 5% 할인 혜택을 받으실 수 있습니다. 화장품, 향수, 주류, 담배, 패션 등 모든 품목에 적용됩니다.',
    terms: [
      '인천국제공항 면세점 전 매장 적용',
      '현장 할인은 출국 당일에만 가능',
  ...
  '5': {
    detailedDescription:
      '골드 등급 이상 SKYPASS 회원이라면 국내외 공항 프리미엄 라운지를 무료로 이용하실 수 있습니다. 편안한 좌석, 무료 음료 및 식사, 샤워 시설 등 다양한 편의시설을 제공합니다.',
    terms: [
  ...
  '6': {
    detailedDescription:
      '제주도의 프리미엄 리조트 숙박권을 특별 가격에 제공합니다. 오션뷰 객실과 다양한 부대시설을 마음껏 이용하며 여유로운 휴가를 보내세요.',
    terms: [
